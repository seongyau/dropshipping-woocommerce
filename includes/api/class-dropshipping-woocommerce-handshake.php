...
if( class_exists( 'WC_REST_System_Status_Controller' ) ):
    ...
    class Knawat_Dropshipping_Woocommerce_Handshake extends WC_REST_System_Status_Controller {
        ...
        /**
         * Check if Knawat WooCommerce is connected or not.
         *
         * @return array
         */
        public function knawat_is_connected(){
            $response = array();
        ...
        /**
         * Knawat Return Last sync date.
         *
         * @return array
         */
        public function knawat_last_sync_date(){
            $response = array();
            $token = $this->knawat_is_connected();
            if ($token['message'] == 'Connected'){
                // Knawat is connected ... and let's get last sync date.
                $latest = new WP_Query(
                    array(
                        'post_type' => 'product',
                        'post_status' => 'publish',
                ...
                if($latest->have_posts()){
                    ...
                    $response['message'] = $modified_date;
                }
            }
            return $response;
        }
